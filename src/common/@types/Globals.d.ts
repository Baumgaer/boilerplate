...
type InternalNames = "className" | "collectionName" | "unProxyfiedObject" | "dummyId";
...
declare var COLLECTION_NAME_TO_MODEL_MAP: Record<string, typeof import("~common/lib/BaseModel").default>;
